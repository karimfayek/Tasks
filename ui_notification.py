...
class Ui_Notification(object):
    def setupUi(self, Notification):
        ...
        self.lbl_mssg = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, Notification):
        Notification.setWindowTitle(QtWidgets.QApplication.translate("Notification", "MainWindow", None))#, QtWidgets.QApplication.UnicodeUTF8
        self.lbl_mssg.setText(QtWidgets.QApplication.translate("Notification", "TextLabel", None)) # , QtWidgets.QApplication.UnicodeUTF8
